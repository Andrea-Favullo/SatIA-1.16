...
public class ItemRevolver extends Item {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, @Nonnull Hand handIn) {
		...
		if(!worldIn.isRemote) {
			//se il revolver non ha un compo8und lo creo, altrimenti uso quello che gi� esiste per quell'istanza
			...
			//se nel compound l'attributo bullets ha pi� di zero proiettili spara, altrimenti ricarica
